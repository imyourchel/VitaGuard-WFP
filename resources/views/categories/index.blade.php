...
<head>
    ...
    <title>Kategori - VitaGuard</title>
...
<body>
    ...
    <div class="page-header">
        <div class="container-lg">
            <h1><i class="fas fa-list me-3"></i>Kategori Layanan</h1>
            <p class="mb-0 mt-2">Daftar seluruh kategori layanan kesehatan kami</p>
        </div>
    </div>
                        ...
                        <table class="table table-hover table-categories">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 15%">Jumlah Layanan</th>
                            ...
                            <tbody>
                                @forelse($categories as $key => $category)
                                    <tr>
                                        ...
                                        <td><span class="badge bg-primary">{{ $category->services->count() }}</span></td>
                                        <td>
                                            @if($category->services->count() > 0)
                                                <div class="d-flex flex-wrap gap-2">
                                                    @foreach($category->services as $service)
                                                        <span class="badge bg-info text-white">{{ $service->service_name }}</span>
                                                    @endforeach
                                                </div>
                                            @else
                                                <span class="text-muted">-</span>
                                ...
                                @empty
                                    <tr><td colspan="5" class="text-center py-4 text-muted">Tidak ada kategori</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
