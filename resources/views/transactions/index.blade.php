...
<head>
    ...
    <title>Transaksi - VitaGuard</title>
...
<body>
    ...
    <div class="page-header">
        <div class="container-lg">
            ...
            <p class="mb-0 mt-2">Lihat semua riwayat transaksi layanan kesehatan Anda</p>
        </div>
    </div>
        ...
        <div class="container-lg py-4">
            @if($allTransactions->isEmpty())
                <div class="text-center py-5">
                    ...
                    <h3 class="text-muted">Tidak Ada Transaksi</h3>
                </div>
            @else
                        ...
                        <table class="table table-hover table-transactions">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 10%">Spesialisasi</th>
                            ...
                            <tbody>
                                @forelse($allTransactions as $key => $transaction)
                                    <tr>
                                        ...
                                        <td><span class="badge bg-info">{{ $transaction->doctor ? $transaction->doctor->specialty : '-' }}</span></td>
                                        ...
                                        <td>
                                            <span class="badge bg-success">Rp {{ number_format($transaction->amount, 0, ',', '.') }}</span>
                                        </td>
                                        <td>
                                ...
                                @empty
                                    <tr><td colspan="10" class="text-center py-4 text-muted">Tidak ada transaksi</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
