...
<head>
    ...
    <title>{{ $doctor->user->name }} - VitaGuard</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-lg">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link {{ request()->routeIs('doctors.index', 'doctors.show') ? 'active' : '' }}" href="{{ route('doctors.index') }}">Dokter</a></li>
    ...
    <div class="page-header">
        <div class="container-lg">
            <a href="{{ route('doctors.index') }}" class="back-button" style="color: white; margin-bottom: 1rem;">
        ...
        <div class="container-lg py-4">
            <div class="doctor-profile-card">
                ...
                <div style="text-align: center; margin-top: 2rem; padding-top: 2rem; border-top: 2px solid #eee;">
                    <a href="{{ route('doctors.index') }}" class="back-button" style="color: var(--primary); font-size: 1rem;">
                        <i class="fas fa-arrow-left"></i>
