...
<head>
    ...
    <title>Detail Transaksi {{ $transaction->transaction_code }} - VitaGuard Admin</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-lg">
            ...
            <span class="navbar-text ms-auto fw-bold">Admin - Detail Transaksi</span>
        </div>
    </nav>
    ...
    <div class="page-header">
        <div class="container-lg" style="width: 100%;">
            <a href="{{ route('admin.fitur', ['fitur' => 'transactions']) }}" class="back-button">
        ...
        <div class="container-lg py-4">
            <div class="transaction-card">
                ...
                <div style="text-align: center; margin-top: 2rem; padding-top: 2rem; border-top: 2px solid #eee;">
                    <a href="{{ route('admin.fitur', ['fitur' => 'transactions']) }}" class="btn btn-secondary">
